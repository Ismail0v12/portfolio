...
const Policy = () => {
  const myWebsite = 'https://potfolio.vercel.app';
  return (
    <div className="container">
      <h1 className="title_fz36">Политика в отношении обработки персональных данных</h1>
      <h4 className="title_fz20">1. Общие положения</h4>
      <h4 className="title_fz16">
      ...
      <h4 className="title_fz20">2. Основные понятия, используемые в Политике</h4>
      <p>
      ...
      <p>
        ...
        или определяемому Пользователю веб-сайта {myWebsite};
      </p>
      <p>2.9. Пользователь – любой посетитель веб-сайта {myWebsite};</p>
      <p>
      ...
      <h4 className="title_fz20">4. Цели обработки персональных данных</h4>
      <p>
        ...
        {myWebsite}; уточнение деталей заказа.
      </p>
      <p>
      ...
      <h4 className="title_fz20">5. Правовые основания обработки персональных данных</h4>
      <p>
        ...
        {myWebsite}. Заполняя соответствующие формы и/или отправляя свои персональные данные
      ...
      <h4 className="title_fz20">7. Трансграничная передача персональных данных</h4>
      <p>
      ...
      <h4 className="title_fz20">8. Заключительные положения</h4>
      <p>
